...
import { SubTopicDocument } from "./subTopic";
import { SubSubTopicDocument } from "./subSubTopic";

// document
export interface SubSubSubTopicDocument extends Document {
  category: string | ObjectId | ContentCategoryDocument;
  topic: string | ObjectId | TopicDocument;
  subTopic: string | ObjectId | SubTopicDocument;
  subSubTopic: string | ObjectId | SubSubTopicDocument;
  name: string;
  slug: string;
  redirectFrom?: string[];
...
// model
export interface SubSubSubTopicModel extends Model<SubSubSubTopicDocument> {}
