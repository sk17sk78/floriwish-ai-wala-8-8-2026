...
export default function AdvancedCheckbox(
  ...
  return (
    ...
    >
      <div className="px-5 py-6 grid grid-rows-[47px_1fr] grid-cols-1 gap-4 rounded-2xl bg-rose-100/70 border border-rose-200">
        ...
        <div className="grid grid-cols-1 auto-rows-min *:flex *:flex-wrap *:items-start *:justify-start *:gap-2">
          <div className="*:bg-rose-500 *:text-white *:rounded-full *:py-1 *:pl-4 *:pr-3 pb-3 border-b border-ash *:cursor-pointer *:transition-all *:duration-300 *:flex *:items-center *:justify-center *:gap-1">
            {options
