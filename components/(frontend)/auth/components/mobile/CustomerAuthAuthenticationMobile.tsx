...
function CustomerAuthAuthenticationMobile() {
  // hooks
  const {
    status,
    ...
    method: {
      ...
      mobile: { onResendOTP, onVerifyOTP }
    }
  } = useCustomerAuth();
            ...
            status === "pending"
              ...
              : () => {
                  if (otp.length === 4) {
                    ...
                    toast({
                      title: "Incorrect OTP",
                      description: "OTP should be 4 digit",
                      variant: "warning"
                    });
                  }
                }
...
export default memo(CustomerAuthAuthenticationMobile);
