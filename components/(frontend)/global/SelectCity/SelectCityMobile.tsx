...
function SelectCityMobile({
  ...
  return (
    <div
      ...
      className={`relative w-full lg:hidden px-4 py-2.5 min-h-[40px] flex items-center z-20 transition-all duration-200 cursor-pointer select-none touch-manipulation active:opacity-90 ${
        shouldShake
    ...
    >
      <div className="flex items-center justify-between gap-2 w-full pointer-events-none">
        <div className="flex items-center gap-2 min-w-0">
          ...
          />
          <span
            className={`text-xs text-left font-medium leading-normal tracking-tight truncate ${
