  ...
  return (
    <ContentVerticalSpacing>
      <ContentHorizontalSpacing>
        <section
          className={`relative bg-white rounded-2xl sm:rounded-3xl border border-zinc-100 p-3.5 sm:p-5 md:p-6 shadow-2xs flex flex-col gap-3 sm:gap-4 w-full ${styles || ""}`}
        >
          ...
          <div className="flex items-center justify-between gap-2 pb-0.5">
            <div className="flex flex-col min-w-0">
              ...
              <h2
                className={`text-base sm:text-xl md:text-2xl font-bold text-zinc-900 tracking-tight mt-0.5 truncate ${titleStyles || ""}`}
              >
                {title}
              </h2>
            </div>
                          ...
                          >
                            {isUploadingPhoto ? (
                              <>
                                ...
                                <span>Optimizing & Uploading to S3 (&lt;100KB WebP)...</span>
                              </>
                            ) : (
                              <>
          ...
          <div className="bg-[#fafafc] rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 border border-zinc-100/90 grid grid-cols-[85px_1fr] min-[380px]:grid-cols-[100px_1fr] sm:grid-cols-[130px_1px_1fr] md:grid-cols-[150px_1px_1fr] lg:grid-cols-[170px_1px_1fr] items-center gap-2.5 min-[380px]:gap-3.5 sm:gap-6 md:gap-8 lg:gap-10 w-full">
            ...
            <div className="flex flex-col items-center sm:items-start text-center sm:text-left shrink-0">
              ...
              <div className="mt-1.5 flex items-center">
                <ContentReviewRating rating={ratingScore} size={13} />
              </div>
