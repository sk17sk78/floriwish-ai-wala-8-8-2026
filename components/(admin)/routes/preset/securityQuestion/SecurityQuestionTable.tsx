...
} from "@/store/features/presets/securityQuestionSlice";
...
export default function SecurityQuestionTable({
  userName,
  isSuperAdmin,
  permission
}: {
  ...
  const [filterKeywordOptions, setFilterKeywordOptions] = useState<
    FilterKeywordOptions<SecurityQuestionDocument>
  >({});
  ...
  return (
    <>
      ...
      <AdminTableLayout
        ...
        collectionName="Security Questions"
        documentName="Security Question"
        createAction={createSecurityQuestionAction}
        select={selectSecurityQuestion}
