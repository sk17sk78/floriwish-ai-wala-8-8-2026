...
export default function DeliveryTypeTable({
  userName,
  isSuperAdmin,
  permission
}: {
  ...
  const [filterKeywordOptions, setFilterKeywordOptions] = useState<
    FilterKeywordOptions<DeliveryTypeDocument>
  >({});
  ...
  return (
    <>
      ...
      <AdminTableLayout
        ...
        collectionName="Delivery Types"
        documentName="Delivery Type"
        createAction={createDeliveryTypeAction}
