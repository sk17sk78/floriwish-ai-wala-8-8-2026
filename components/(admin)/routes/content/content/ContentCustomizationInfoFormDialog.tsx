...
// components
const LazyContentCustomizationInfoForm = lazy(
  () => import("./ContentCustomizationInfoForm")
);
...
export default function ContentCustomizationInfoFormDialog({
  initialDocumentId,
  onUpdate
}: {
  ...
  if (initialDocument) {
    return (
      <Dialog>
        ...
        >
          <Suspense fallback={<></>}>
            <LazyContentCustomizationInfoForm
