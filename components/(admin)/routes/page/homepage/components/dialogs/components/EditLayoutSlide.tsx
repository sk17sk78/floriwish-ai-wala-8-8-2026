...
export default function EditLayoutSlide({
  ...
  const [imagesToSelect, setImagesToSelect] = useState<5 | 6>(6);
  const [imgFreq, setImgFreq] = useState<number>(0);
          ...
          <div className="space-y-6 pt-8">
            <div className="flex items-center justify-start gap-4">
              ...
              <div className="flex items-center justify-start gap-2">
                <CustomToggle
                  label=""
                  toggled={(layout as any).scrollable || false}
                  onToggle={(val: boolean) =>
                    setLayout((prev) =>
                      prev === undefined
                        ? undefined
                ...
                <Input
                  ...
                  customValue={{
                    value:
                      ...
                      (layout.layout.banner?.type as string)
                        ? (layout.layout.banner?.type as string)
                        : "default",
            ...
            <div className="flex items-center justify-start gap-x-10">
              ...
              <div
                ...
                onClick={() => {
                  ...
                  setLayout((prev) =>
                    prev ? { ...prev, isModified: true } : undefined,
                  );
                }}
              >
                Add Banner
                ...
                <SelectImage
                  ...
                  onChangeValue={(selectedIds: string[]) => {
                    ...
                    const newImages = selectedIds.map((id) => {
                      ...
                      const img = allImages.find((img) => String(img._id) === String(id));
                      return {
                        _id: generateRandomId(20),
                        label: "",
                        path: "",
                                      ...
                                      customValue={{
                                        ...
                                        setValue: (str: string) => {
                                          ...
                                          setLayout((prev) => {
                                            if (
                                              !prev ||
                                              !prev.layout?.collage?.images
                                            )
                                              return prev;

                                            const images = prev.layout.collage
                                              .images as QuickLinkDocument[];
                                            const imageObj =
...
const BannerImageRow = ({
  ...
  return (
    <>
                        ...
                        ? {
                            ...
                            images: prev.layout.banner.images.length
                              ? prev.layout.banner.images.map((img) =>
                                  String(img._id) === String(banner._id)
                                    ? {
                                        ...img,
                                        desktop: relevantImageDoc || undefined,
                                      }
                                    : img,
                                )
                              : [],
                            ...
                            images: prev.layout.banner.images.length
                              ? prev.layout.banner.images.map((img) =>
                                  String(img._id) === String(banner._id)
                                    ? {
                                        ...img,
                                        mobile: relevantImageDoc || undefined,
                                      }
                                    : img,
                                )
                              : [],
      ...
      >
        <Trash2 width={19} height={19} strokeWidth={1.5} />
      </div>
    </>
  );
};
