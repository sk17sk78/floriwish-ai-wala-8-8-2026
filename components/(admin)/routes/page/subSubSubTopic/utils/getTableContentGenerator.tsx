        ...
        ({
          ...
          cols: [
            ...
            },
            {
              value: {
                label:
                  subSubTopics.find(({ _id }) => String(_id) === String(subSubTopic))?.name || "",
                type: "text",
                align: "left"
              },
              action: { action: () => { }, type: "none" }
              ...
              value: {
                label: (
                  <TupleActions
                      ...
                      revalidateSubSubSubTopicPage({
                        ...
                        subTopicSlug:
                          subTopics.find(({ _id }) => String(_id) === String(subTopic))
                            ?.slug || "",
                        subSubTopicSlug:
                          subSubTopics.find(({ _id }) => String(_id) === String(subSubTopic))
                            ?.slug || "",
                    ...
                    showExternalLink
                    linkHref={`/${contentCategories.find(({ _id }) => String(_id) === String(category))?.slug}/${topics.find(({ _id }) => String(_id) === String(topic))?.slug}/${subTopics.find(({ _id }) => String(_id) === String(subTopic))?.slug}/${subSubTopics.find(({ _id }) => String(_id) === String(subSubTopic))?.slug}/${slug}`}
                  />
                ),
                type: "svg"
              },
