...
export const fetchBlogCount = (renderingStrategy?: "SSR" | "ISR") => {
  return new Promise<ResponseDataType<number>>(async (resolve, reject) => {
    try {
      ...
      const response: Response = await fetch(
        `${DOMAIN}/api/frontend/blog/count`,
        {
          method: "GET",
      ...
      const responseData: ResponseDataType<number> = await response.json();
