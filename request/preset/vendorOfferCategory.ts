...
export const fetchVendorOfferCategories = (
  renderingStrategy?: "SSR" | "ISR"
) => {
  return new Promise<ResponseDataType<VendorOfferCategoryDocument[]>>(
    async (resolve, reject) => {
      try {
        ...
        const response: Response = await fetch(
          `${DOMAIN}/api/frontend/preset/vendor-offer-category`,
          {
            method: "GET",
        ...
        const responseData: ResponseDataType<VendorOfferCategoryDocument[]> =
          await response.json();
