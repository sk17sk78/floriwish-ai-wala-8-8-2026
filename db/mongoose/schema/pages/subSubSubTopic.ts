...
// types
import {
  SubSubSubTopicDocument,
  SubSubSubTopicModel
} from "@/common/types/documentation/pages/subSubSubTopic";

// schema
export const subSubSubTopicSchema = new Schema<SubSubSubTopicDocument, SubSubSubTopicModel>(
  {
    category: {
...
// Performance index
subSubSubTopicSchema.index({ slug: 1, subSubTopic: 1, isActive: 1 });
