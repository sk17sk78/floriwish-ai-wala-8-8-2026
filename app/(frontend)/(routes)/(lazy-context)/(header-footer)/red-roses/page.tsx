...
export async function generateMetadata(
  ...
  try {
    ...
    // Fallback metadata for red-roses
    return {
        title: "Red Roses Delivery | Fresh Red Roses Bouquets - Floriwish",
        description: "Express your love with fresh red rose bouquets from Floriwish. Same-day delivery available in your city."
    } as Metadata;
  }
...
export default async function page() {
  ...
  const breadcrumbsData: BreadcrumbsType[] = [
    {
      label: (contentCategory as ContentCategoryDocument)?.name || "Red Roses",
      link: `/red-roses`
    }
  ];
